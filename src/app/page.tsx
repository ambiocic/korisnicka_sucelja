    ...
    >
      ...
      <div className="bg-background md:w-2/5 w-full p-6 md:p-8 flex flex-col justify-between relative z-10">
        <div>
          ...
          <p className="text-yellow-500 font-bold mb-4 md:mb-6 text-xl">Rating: {item.rating}</p>
        </div>
        <button
          onClick={(e) => {
          ...
          className="bg-yellow-400 text-black py-2 md:py-3 px-6 md:px-8 rounded-xl hover:bg-yellow-500 font-bold w-full md:w-auto transition"
        >
          Add to Watchlist
        </button>
      </div>
